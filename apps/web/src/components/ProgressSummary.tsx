  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="rounded-lg bg-blue-600  p-4 sm:p-6 text-white"
      >
        ...
        <p className="mt-2 text-2xl sm:text-3xl font-bold">{thisWeeksWorkouts.length}</p>
      ...
      <motion.div
        whileHover={{ scale: 1.02 }}
        className="bg-slate-700 dark:bg-slate-600  p-4 sm:p-6 text-white"
      >
        <div className="flex items-center justify-between">
        ...
        <p className="mt-2 text-2xl sm:text-3xl font-bold">{totalDuration}m</p>
      ...
      <motion.div
        whileHover={{ scale: 1.02 }}
        className="rounded-lg bg-emerald-600  p-4 sm:p-6 text-white"
      >
        <div className="flex items-center justify-between">
        ...
        <p className="mt-2 text-2xl sm:text-3xl font-bold">{weightChange > 0 ? "+" : ""}{weightChange.toFixed(1)}kg</p>
