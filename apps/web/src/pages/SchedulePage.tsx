  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between mb-8">
        <h1 className="text-xl font-semibold text-gray-900 dark:text-white">My Workout Schedule</h1>
      </div>
        ...
        {days.map((day, index) => {
          ...
          return (
            <motion.div
              ...
              className="bg-white dark:bg-gray-800  p-4 sm:p-6 shadow-md rounded-xl border border-gray-200 dark:border-gray-700 cursor-pointer hover:shadow-md transform hover:-translate-y-1 transition-all duration-300"
              onClick={() => setEditingDay(day)}
            >
              <div className="text-center mb-6">
                <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">{day}</h2>
                ...
                {daySchedule.length === 0 ? (
                  ...
                  daySchedule.map((item, itemIndex) => (
                    <motion.div
                      ...
                      className="rounded-lg bg-gray-50 dark:bg-gray-800 p-3  border border-gray-200/50 dark:border-gray-600/50 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-all duration-200"
                    >
                      <div className="flex flex-col gap-2">
                        ...
                        <div className="flex items-start gap-2">
                          ...
                          <span className="font-medium text-sm text-gray-800 dark:text-white break-words break-all line-clamp-2 leading-tight">{item.activity}</span>
                        </div>
                      </div>
                    </motion.div>
                  ))
